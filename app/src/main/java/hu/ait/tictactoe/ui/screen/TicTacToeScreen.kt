...
// - I made 2 different colors for X and O
// also made a winner detector
...
fun TicTacToeScreen(
    ...
    Column(
        ...
        Text(
            text = context.getString(R.string.text_current_player, currentPlayer.name),
